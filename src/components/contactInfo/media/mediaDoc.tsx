...
const MediaDoc = () => {
  return (
    <div
      role="button"
      className="w-full flex gap-2 flex-col shadow-md bg-zinc-100 dark:bg-neutral-800 py-2 px-2 rounded-md"
    >
      {/* preview image */}
      <div className="min-w-full min-h-[120px] max-h-[130px] bg-slate-400 dark:bg-neutral-700"></div>

      <div className="flex gap-2 justify-between items-center w-full ">
        <div className="flex gap-2 items-center flex-1">
          <ImFilePdf size={25} className="text-rose-600" />
          <span className="text-slate-700 dark:text-gray-300 text-[12px]">
